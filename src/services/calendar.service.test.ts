  ...
  describe('Event Retrieval Operations', () => {
    ...
    test('should return event for valid ID', async () => {
      ...
      const mockEvent = {
        ...
        start: {
          dateTime: '2023-12-01T14:00:00-05:00',
          timeZone: 'America/New_York',
        },
        end: {
          dateTime: '2023-12-01T15:30:00-05:00',
          timeZone: 'America/New_York',
        },
        location: 'Board Room',
        status: 'confirmed',
  ...
  describe('Event Creation Operations', () => {
    ...
    test('should create new event', async () => {
      ...
      const eventData = {
        ...
        start: {
          dateTime: '2023-12-15T10:00:00-05:00',
          timeZone: 'America/New_York',
        },
        end: {
    ...
    test('should validate event creation parameters', async () => {
      const result1 = await calendarService.createEvent('', {
        summary: 'Test',
      });
      expect(result1.isErr()).toBe(true);

      const result2 = await calendarService.createEvent(
