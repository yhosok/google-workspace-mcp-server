...
describe('SchemaFactory', () => {
  describe('createSpreadsheetIdSchema', () => {
    it('should create a valid zod string schema for spreadsheet ID', () => {
      ...
      expect(() =>
        schema.parse('1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms')
      ).not.toThrow();
  ...
  describe('createRangeSchema', () => {
    ...
    it('should have appropriate description', () => {
      ...
      expect(schema.description).toBe(
        'The A1 notation range (e.g., "Sheet1!A1:D10" or "A1:D10")'
      );
    });
  });
  ...
  describe('createValuesSchema', () => {
    ...
    it('should have appropriate description', () => {
      const schema = SchemaFactory.createValuesSchema();
      expect(schema.description).toBe(
        '2D array of string values to write/append'
      );
    });
  });
  ...
  describe('createToolInputSchema', () => {
    ...
    it('should throw error for unknown tool', () => {
      expect(() =>
        SchemaFactory.createToolInputSchema('unknown-tool' as any)
  ...
  describe('createResponseSchema', () => {
    it('should create schema for google-workspace__sheets__list-spreadsheets response', () => {
      const schema = SchemaFactory.createResponseSchema(
        'google-workspace__sheets__list-spreadsheets'
      );
    ...
    it('should throw error for unknown response type', () => {
      expect(() =>
        SchemaFactory.createResponseSchema('unknown-tool' as any)
  ...
  describe('validateToolInput', () => {
    it('should validate google-workspace__sheets__list-spreadsheets input successfully', () => {
      const result = SchemaFactory.validateToolInput(
        'google-workspace__sheets__list-spreadsheets',
        {}
      );
    ...
    it('should handle unknown tool gracefully', () => {
      expect(() =>
        SchemaFactory.validateToolInput('unknown-tool' as any, {})
      ).toThrow('Unknown tool: unknown-tool');
    });
  });
  ...
  describe('Edge cases and type safety', () => {
    ...
    it('should maintain type safety across schema operations', () => {
      ...
      const responseSchema = SchemaFactory.createResponseSchema(
        'google-workspace__sheets__write-range'
      );
