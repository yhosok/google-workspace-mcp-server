import { SheetsAppendTool } from '../../tools/sheets/append.tool.js';
...
describe('SheetsAppendTool', () => {
  ...
  describe('executeImpl', () => {
    test('should append data to spreadsheet successfully', async () => {
      ...
      if (result.isOk()) {
        ...
        const resultData = JSON.parse(text!) as SheetsAppendResult;
  ...
  describe('error handling', () => {
    test('should handle unexpected errors', async () => {
      ...
      mockSheetsService.appendData.mockRejectedValue(
